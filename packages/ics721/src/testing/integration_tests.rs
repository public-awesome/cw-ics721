...
fn test_do_instantiate_and_mint() {
    // test case: instantiate cw721 with no ClassData (without owner, name, and symbol)
    {
        ...
        let contract_info: CollectionInfoAndExtensionResponse<DefaultOptionalCollectionExtension> =
            test.app
                .wrap()
                .query_wasm_smart(
                    nft_contract.clone(),
...
fn test_do_instantiate_and_mint_2_different_collections() {
    // test case: instantiate two cw721 contracts with different class id and make sure instantiate2 creates 2 different, predictable contracts
    {
        ...
        // check name and symbol contains class id for instantiated nft contract
        let contract_info_1: CollectionInfoAndExtensionResponse<
        ...
        > = test
            ...
            .unwrap();
        let contract_info_2: CollectionInfoAndExtensionResponse<
            DefaultOptionalCollectionExtension,
        > = test
            .app
            .wrap()
        ...
        assert_eq!(
            ...
            CollectionInfoAndExtensionResponse {
                ...
                extension: None,
                updated_at: contract_info_1.updated_at,
            }
        );
        assert_eq!(
            contract_info_2,
            CollectionInfoAndExtensionResponse {
                ...
                extension: None,
                updated_at: contract_info_2.updated_at,
            }
        );
